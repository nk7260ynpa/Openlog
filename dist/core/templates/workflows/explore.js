...
export function getExploreSkillTemplate() {
    return {
        ...
        description: "Read-only investigation of the codebase that produces a structured report and a paste-ready handoff for /oplg:apply. Triggers when the user runs /oplg:explore or asks to \"investigate / survey / where is X / how does Y work\" before any code change. Must not modify files, commit, or push.",
...
export function getOplgExploreCommandTemplate() {
    return {
        name: 'OPLG: Explore',
        description: "Read-only investigation that organizes findings and hands them off to /oplg:apply (usage: /oplg:explore <topic>)",
        category: 'Workflow',
